...
Now, let's burn the code to the Arduino. First, you need to know the Arduino device path. Use <br><code>dmesg | grep ttyUSB*</code> and find the path for the ch341-UART chip (if its the only thing attached to your computer,probably it will be in dev/ttyUSB0 ) <br>
